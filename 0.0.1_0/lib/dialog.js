	...
	$.fn.dialog = function(options,callBack){
	    ...
	    var _init = function(){
		    ...
		    _overflowBtn();
		     ...
		     _this.dialog_div = $("<div class='div_dialog animated "+opt.className+" "+opt.type+" "+opt.animateIn+"'></div>").css({
		     	// 'visibility':'hidden',
				'width':opt.width,
				'height':opt.height,
        ...
        var renderChildren = opt.discription;
				if (opt.children) { renderChildren = opt.children }
		    $("<div class='discription_dialog'></div>").html(renderChildren).css('font-size',opt.discriptionFontSize).appendTo(_this.dialog_div);
	    ...
	    var _initIE = function(){
		    ...
		    _overflowBtn();
		     ...
		     _this.dialog_div = $("<div class='div_dialog "+optclassName+opt.type+" '></div>").css({
		     	'visibility':'hidden',
				'width':opt.width,
				'height':opt.height,
				'background':opt.dialogBg,
